...
def keyy():
    global getter_s, getter, killer
    getter_s = None
    killer = True
    while killer:
        getter = repr(readchar()).lower()
        getter_s = getter
# ==============================================================================================
...
while True:
    ...
    game_size = 10
    fig_list = []
    difficulty = int(input('enter the difficulty of game(from 1 to 10): '))
    timing = 1.60 - (difficulty * 0.15)
    ...
    while True:
                ...
                if ff_counter == 1:
                    ...
                    get_key = threading.Thread(target=keyy)
                    ff_counter = 3
                    get_key.start()
                    time.sleep(timing)
                else:
